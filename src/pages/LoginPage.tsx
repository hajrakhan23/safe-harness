    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md bg-card rounded-2xl shadow-elevated p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-display font-bold text-foreground">Suraksha360</h1>
        ...
        <button onClick={handleGoogle}
          className="w-full py-2.5 rounded-lg border border-input bg-background text-foreground font-medium hover:bg-muted transition flex items-center justify-center gap-2">
        ...
        <p className="text-center text-sm text-muted-foreground">
          {t('dontHaveAccount')} <Link to="/signup" className="text-primary hover:underline">{t('signup')}</Link>
        </p>
      </div>
    </div>
  );
